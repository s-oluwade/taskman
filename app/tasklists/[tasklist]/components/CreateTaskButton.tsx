...
import {CheckIcon, Pencil1Icon, ReloadIcon, StarIcon} from '@radix-ui/react-icons';
import {Separator} from '@/components/ui/separator';
import {generateLabelGPT, getAnimationGPT} from '../actions';
...
const CreateTaskButton = ({tasklistName}: CreateTaskButtonProps) => {
  ...
  const [creatingTask1, setCreatingTask1] = useState<boolean | undefined>(undefined);
  const [creatingTask2, setCreatingTask2] = useState<boolean | undefined>(undefined);

  async function handleCreateTask(e: React.MouseEvent<HTMLButtonElement, MouseEvent>, auto: boolean) {
    e.stopPropagation();
    let animation = await getAnimationGPT(label);
              ...
              <SelectGroup id='label' className='flex flex-wrap gap-2 justify-center'>
                <Select
                  ...
                  <SelectContent className='overflow-y-auto max-h-[30rem]'>
                    ...
                    <SelectItem className='cursor-pointer hover:bg-accent' value='custom'>
                      Custom <Pencil1Icon className='ml-1 w-4 h-4 inline' />
                    </SelectItem>
                  </SelectContent>
                </Select>
                <Input
